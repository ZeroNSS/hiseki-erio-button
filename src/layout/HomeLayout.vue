            ...
            <v-tooltip bottom>
                <template #activator="{on: tooltip}">
                    <v-btn
                        icon
                        class="white--text"
                        href="https://github.com/ZeroNSS/hiseki-erio-button"
                        target="_blank"
                        v-on="{...tooltip}"
                    >
                        <v-icon size="28">
...
const menuList = computed(() => [
    ...
    },
    {
        ...
        fun(){
            window.open('https://space.bilibili.com/407106379')
        },
    },
    {
        icon: 'iconfont icon-youtube',
        name: i18n.t('menu.Youtube'),
        fun(){
            window.open('https://www.youtube.com/channel/UCQ7KYc1-IMQ8_Uz7XTE5DWw')
        },
    },
    {
        icon: 'iconfont icon-twitter',
        name: i18n.t('menu.Twitter'),
        fun(){
            window.open('https://twitter.com/hiseki_erio')
        },
    },
    {
    ...
    },
    {
        ...
        fun(){
            ...
            if (process.env.NODE_ENV === 'production') {
                url = `https://cdn.jsdelivr.net/gh/ZeroNSS/hiseki-erio-button@latest/public${localZipPath}`
            } else {
                url = localZipPath
            }
            window.open(url)
